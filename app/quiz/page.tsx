...
export default function QuizPage() {
  ...
  const optionColors: Record<string, { base: string; correct: string; wrong: string }> = {
    A: { base: "#6366f1", correct: "#10b981", wrong: "#ef4444" },
    B: { base: "#2563EB", correct: "#10b981", wrong: "#ef4444" },
    C: { base: "#8b5cf6", correct: "#10b981", wrong: "#ef4444" },
    D: { base: "#06b6d4", correct: "#10b981", wrong: "#ef4444" },
  };
        ...
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          ...
          {loading ? (
            ...
            <div style={{ ...glass, padding: "40px", textAlign: "center" }}>
              ...
              <h3 style={{ color: "#F8FAFC", fontSize: "22px", fontWeight: 700, marginBottom: "8px" }}>
                Quiz Complete!
              </h3>
              <p style={{ color: "#60A5FA", fontSize: "32px", fontWeight: 700, marginBottom: "8px" }}>
                {score} / {quiz.total}
              </p>
              ...
              <div style={{ display: "flex", gap: "12px", justifyContent: "center" }}>
                <button onClick={() => { setCurrent(0); setSelected(null); setRevealed(false); setScore(0); setAnswers([]); setFinished(false); }}
            ...
            <>
              ...
              <div style={{ height: "4px", background: "rgba(255,255,255,0.06)", borderRadius: "999px", marginBottom: "24px" }}>
                <div style={{ height: "100%", width: `${((current + 1) / quiz.total) * 100}%`, background: "linear-gradient(90deg, #2563EB, #60A5FA)", borderRadius: "999px", transition: "width 0.3s" }} />
              </div>

              {/* Question */}
              <div style={{ ...glass, padding: "24px", marginBottom: "16px" }}>
                <p style={{ color: "#F8FAFC", fontSize: "16px", lineHeight: 1.6, margin: 0 }}>
                  {q.question}
                </p>
              </div>
                  ...
                  return (
                    <button key={key} onClick={() => handleAnswer(key)} disabled={revealed} style={{
                      ...
                      <span style={{
                        ...
                        background: revealed && isCorrect ? "rgba(16,185,129,0.2)" : "rgba(255,255,255,0.05)",
